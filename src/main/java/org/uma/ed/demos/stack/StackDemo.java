...
public class StackDemo {
  public static void main(String[] args) {
    ...
    Stack<Integer> stack2 = LinkedStack.empty(); // ArrayStack.empty();
    stack2.push(1);
    stack2.push(2);
    stack2.push(3);
    ...
    Stack<Integer> stack3 = LinkedStack.of(1, 2, 3);  // ArrayStack.empty();
    ...
    Stack<Integer> stack4 = LinkedStack.from(Range.inclusive(0, 10, 2)); // ArrayStack.empty();
